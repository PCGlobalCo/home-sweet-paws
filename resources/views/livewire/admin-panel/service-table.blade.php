<div>
    <div class="relative m-4 md:flex md:justify-between md:items-center">
        <div class="md:flex grid grid-cols-1">
            <a href="{{ route('service.create') }}" wire:navigate> <button type="button"
            ...
            <tbody>
                @foreach ($records as $record)
                    <tr class="bg-white border-b d:bg-gray-800 d:border-gray-700">
                        ...
                        <td class="px-6 py-20 flex justify-center items-center space-x-4">
                            <a href="{{ route('service.edit', $record->id) }}" wire:navigate
