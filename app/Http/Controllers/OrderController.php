...
class OrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $order->delivery_date = isset($inputs['delivery_date']) ? $inputs['delivery_date'] : null;
        $order->delivery_time = isset($inputs['delivery_time']) ? $inputs['delivery_time'] : null;
        $order->delivery_instructions = isset($inputs['delivery_instructions']) ? $inputs['delivery_instructions'] : null;
        $order->save();
