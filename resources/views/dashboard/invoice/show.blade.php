            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 text-nowrap font-semibold">
                            {{ session('lang') == 'en' ? 'Preferred Delivery Date' : 'تاريخ التوصيل المفضل' }}
                        </th>
                        <th scope="col" class="px-6 py-3 text-nowrap font-semibold">
                            {{ session('lang') == 'en' ? 'Preferred Delivery Time' : 'وقت التوصيل المفضل' }}
                        </th>
                    </tr>
                </thead>
                <tbody>
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    @foreach ($items as $item)
                        @if (!empty($item->product))
                            <tr
                                class="bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-750 transition-colors duration-200">
                                <!-- Product Image -->
                                <td class="p-4">
                                    <div
                                        class="w-16 h-16 md:w-20 md:h-20 rounded-lg overflow-hidden bg-gray-100 dark:bg-gray-700 flex items-center justify-center">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <span
                                            class="inline-flex items-center justify-center w-8 h-8 bg-blue-100 text-blue-800 text-sm font-semibold rounded-full dark:bg-blue-900 dark:text-blue-300">
                                            {{ $item->quantity }}
                                        </span>
                                    </div>
                                </td>
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-2 sm:space-y-0">
                ...
                <div class="flex items-center space-x-2 rtl:space-x-reverse">
                    ...
                    <span
                        ...
                        @if ($record->status == 'delivered') bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200
